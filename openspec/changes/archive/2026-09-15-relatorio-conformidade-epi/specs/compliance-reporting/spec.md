...
O projeto SHALL gerar um relatório (CSV com os eventos brutos + Markdown com resumo) mostrando, por classe de violação: número de eventos, tempo total de violação e percentual do vídeo com violação, além da lista dos eventos individuais.
